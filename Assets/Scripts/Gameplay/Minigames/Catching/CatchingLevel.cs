...
public class CatchingLevel : MonoBehaviour
{
    ...
    private void OnTimeEnded() => _victory.CheckCondition();
    
    private void OnConditionChecked(bool isVictory)
    {
        _eggSpawner.StopSpawning();
    ...
    private void HandleDefeat() => _resultUI.ShowDefeat();
    ...
    public void OnContinue() => SceneLoader.LoadLetterScene(_gameState.currentLevel + 1);
}
